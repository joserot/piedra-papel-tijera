...
var _welcomePage = require("./pages/welcome/welcomePage");
var _rulesPage = require("./pages/rules/rulesPage");
var _playPage = require("./pages/play/playPage");
var _resultPage = require("./pages/result/resultPage");
const initApp = (params)=>{
    //State
    (0, _state.state).initState();
    // Pages
    (0, _welcomePage.initWelcomePage)();
    (0, _rulesPage.initRulesPage)();
    (0, _playPage.initPlayPage)();
    (0, _resultPage.initResultPage)();
    // Components
    (0, _button.initButton)();
    (0, _text.initText)();
    (0, _piedra.initPiedra)();
    (0, _papel.initPapel)();
    (0, _tijera.initTijera)();
...
},{"./router":"4QFWt","./components/Button":"a24OL","./components/Text":"6DhqQ","./components/Piedra":"14f9t","./components/Papel":"2etTH","./components/Tijera":"k7c6U","./components/Counter":"92jaz","./pages/welcome/welcomePage":"6lMri","./pages/rules/rulesPage":"lPHhz","./pages/play/playPage":"hnthl","./pages/result/resultPage":"dyXq5","./state":"1Yeju"}],"4QFWt":[function(require,module,exports) {
var _router = require("@vaadin/router");
const router = new (0, _router.Router)(document.getElementById("root"));
router.setRoutes([
    {
        path: "/",
...
},{}],"a24OL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initButton() {
    class ButtonElement extends HTMLElement {
        ...
        render() {
            ...
            /* STYLES */ let styles = document.createElement("style");
            styles.innerHTML = `
     .btn{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6DhqQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"14f9t":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"2etTH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./helpers/bundle-url":"lgJ39"}],"k7c6U":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initTijera() {
    class TijeraElement extends HTMLElement {
        ...
        render() {
            ...
            let tijera = document.createElement("img");
            tijera.src = url;
            /* STYLES */ let styles = document.createElement("style");
            styles.innerHTML = `
     img{
...
},{"url:../img/tijeras.png":"4a2rT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4a2rT":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("7UhFu") + "tijeras.624d8247.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"92jaz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6lMri":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initWelcomePage() {
    class WelcomePage extends HTMLElement {
      ...
      `;
            /*********************STYLES *************************/ const style = document.createElement("style");
            style.innerHTML = `
      .container{
        width: 100vw;
        height: 100vh;
    ...
    .hands-container{
      ...
      `;
            ...
            shadow.appendChild(div);
            /********************FUNCTIONS *************************/ const next = div.querySelector("component-button");
            next.addEventListener("click", ()=>{
                (0, _router.Router).go("/reglas");
            });
        }
    }
...
},{"@vaadin/router":"kVZrF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lPHhz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initRulesPage", ()=>initRulesPage);
var _router = require("@vaadin/router");
...
},{"@vaadin/router":"kVZrF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hnthl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initPlayPage() {
    ...
    .hands-container-pc{
      ...
      `;
            shadow.appendChild(style);
            shadow.appendChild(div);
            /********************FUNCTIONS *************************/ const $piedra = div.querySelector("#piedra"), $papel = div.querySelector("#papel"), $tijera = div.querySelector("#tijera"), $counter = div.querySelector("component-counter");
            ...
            const pcPlay = (userPlay)=>{
                ...
                const displaysPc = ()=>{
                    const $piedraPc = div.querySelector("#piedra-pc"), $papelPc = div.querySelector("#papel-pc"), $tijeraPc = div.querySelector("#tijera-pc");
                    if (pcPlayed === "piedra") {
                ...
                (0, _state.state).addCurrentPlay(pcPlayed, userPlayed);
                setTimeout(()=>{
                    (0, _router.Router).go("/resultado");
                }, 1500);
            };
...
},{"@vaadin/router":"kVZrF","../../state":"1Yeju","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1Yeju":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const state = {
    ...
    initState () {
        ...
        lastWinStorage !== null && (this.lastWin = lastWinStorage);
        let historyUserStorage = Number(localStorage.getItem("historyUser"));
        let historyPcStorage = Number(localStorage.getItem("historyPc"));
        historyUserStorage !== null && (this.history.user = historyUserStorage);
        historyPcStorage !== null && (this.history.pc = historyPcStorage);
    },
    /* Agrega la jugada actual */ addCurrentPlay (jugadaPc, JugadaUser) {
        state.setState({
            currentGame: {
    ...
    whoWin (playPc, playUser) {
        let result = "";
        if (playPc === playUser) result = "tie";
        else if (playPc === "piedra" && playUser === "papel") result = "userWin";
        else if (playPc === "piedra" && playUser === "tijera") result = "pcWin";
        else if (playPc === "papel" && playUser === "piedra") result = "pcWin";
        else if (playPc === "papel" && playUser === "tijera") result = "userWin";
        else if (playPc === "tijera" && playUser === "piedra") result = "userWin";
        else if (playPc === "tijera" && playUser === "papel") result = "pcWin";
    ...
    historyPush (result) {
        ...
        if (result === "pcWin") data.pc = data.pc + 1;
        else if (result === "userWin") data.user = data.user + 1;
        else if (result === "tie") data;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dyXq5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initResultPage() {
    class ResultPage extends HTMLElement {
        ...
        render() {
            ...
            let historyUser = "";
            let historyPc = "";
            /********************FUNCTIONS *************************/ // Asigna el texto del resultado
            const assignResult = ()=>{
                let lastWin = (0, _state.state).lastWin;
                if (lastWin === "pcWin") result = "Perdiste";
                if (lastWin === "userWin") result = "Ganaste";
                if (lastWin === "tie") result = "Empate";
            };
            assignResult();
            ...
            const assignClass = ()=>{
                ...
                let lastWin = (0, _state.state).lastWin;
                if (lastWin === "pcWin") $resultEl?.classList.add("perdiste");
                if (lastWin === "userWin") $resultEl?.classList.add("ganaste");
                if (lastWin === "tie") $resultEl?.classList.add("empate");
            };
            const historyPlays = (hUser, hPc)=>{
                historyUser = hUser;
                historyPc = hPc;
            };
            historyPlays((0, _state.state).history.user, (0, _state.state).history.pc);
            /*********************************************/ div.innerHTML = `
      <div class="container">
          <h2>${result}</h2>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@vaadin/router":"kVZrF","../../state":"1Yeju"}]},["17ZdQ","h7u1C"], "h7u1C", "parcelRequire5feb")
